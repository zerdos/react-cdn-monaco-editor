    ...
    return new Promise(async function (resolve) {
        ...
        require(["vs/editor/editor.main"], async function () {
            ...
            if (monacoLang !== "html") {
                (async () => {
                    (async () => {
                        return monaco.languages.typescript.typescriptDefaults.addExtraLib(await (await fetch("https://unpkg.com/@types/react@latest/index.d.ts")).text(), "file:///node_modules/@types/react/index.d.ts");
                    })();
                    (async () => {
